...
type FakeEnvironments struct {
	Fake *FakeEnvironmentV1alpha1
	ns   string
}

var environmentsResource = schema.GroupVersionResource{Group: "environment.dynatrace.kubeform.com", Version: "v1alpha1", Resource: "environments"}

var environmentsKind = schema.GroupVersionKind{Group: "environment.dynatrace.kubeform.com", Version: "v1alpha1", Kind: "Environment"}
