...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/apis/custom/v1alpha1"
...
// CustomV1alpha1Client is used to interact with features provided by the custom.dynatrace.kubeform.com group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) Anomalieses(namespace string) AnomaliesInterface {
	return newAnomalieses(c, namespace)
}

func (c *CustomV1alpha1Client) Services(namespace string) ServiceInterface {
