...
// ServiceV1alpha1Client is used to interact with features provided by the service.dynatrace.kubeform.com group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) Anomalieses(namespace string) AnomaliesInterface {
	return newAnomalieses(c, namespace)
}

func (c *ServiceV1alpha1Client) Namings(namespace string) NamingInterface {
