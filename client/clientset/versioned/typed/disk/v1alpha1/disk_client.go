...
// DiskV1alpha1Client is used to interact with features provided by the disk.dynatrace.kubeform.com group.
type DiskV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DiskV1alpha1Client) Anomalieses(namespace string) AnomaliesInterface {
