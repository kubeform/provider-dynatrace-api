...
// AzureV1alpha1Client is used to interact with features provided by the azure.dynatrace.kubeform.com group.
type AzureV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AzureV1alpha1Client) Credentialses(namespace string) CredentialsInterface {
