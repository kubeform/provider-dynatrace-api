...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/apis/slo/v1alpha1"
...
// SloV1alpha1Client is used to interact with features provided by the slo.dynatrace.kubeform.com group.
type SloV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SloV1alpha1Client) Slos(namespace string) SloInterface {
