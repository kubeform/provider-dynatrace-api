...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/clientset/versioned/typed/application/v1alpha1"
...
func (c *FakeApplicationV1alpha1) Anomalieses(namespace string) v1alpha1.AnomaliesInterface {
