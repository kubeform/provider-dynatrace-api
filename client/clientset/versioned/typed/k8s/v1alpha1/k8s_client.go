...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/apis/k8s/v1alpha1"
...
// K8sV1alpha1Client is used to interact with features provided by the k8s.dynatrace.kubeform.com group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) Credentialses(namespace string) CredentialsInterface {
