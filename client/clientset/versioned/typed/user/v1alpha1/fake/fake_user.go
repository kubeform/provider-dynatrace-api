...
var usersResource = schema.GroupVersionResource{Group: "user.dynatrace.kubeform.com", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "user.dynatrace.kubeform.com", Version: "v1alpha1", Kind: "User"}
