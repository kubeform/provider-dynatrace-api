...
var groupsResource = schema.GroupVersionResource{Group: "user.dynatrace.kubeform.com", Version: "v1alpha1", Resource: "groups"}

var groupsKind = schema.GroupVersionKind{Group: "user.dynatrace.kubeform.com", Version: "v1alpha1", Kind: "Group"}
