...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/apis/user/v1alpha1"
...
// UserV1alpha1Client is used to interact with features provided by the user.dynatrace.kubeform.com group.
type UserV1alpha1Client struct {
	restClient rest.Interface
}

func (c *UserV1alpha1Client) Groups(namespace string) GroupInterface {
