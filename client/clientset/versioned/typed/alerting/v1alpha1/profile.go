...
func newProfiles(c *AlertingV1alpha1Client, namespace string) *profiles {
	return &profiles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *profiles) UpdateStatus(ctx context.Context, profile *v1alpha1.Profile, opts v1.UpdateOptions) (result *v1alpha1.Profile, err error) {
	result = &v1alpha1.Profile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("profiles").
