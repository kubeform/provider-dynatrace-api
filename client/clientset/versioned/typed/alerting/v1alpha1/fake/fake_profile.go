...
type FakeProfiles struct {
	Fake *FakeAlertingV1alpha1
	ns   string
}

var profilesResource = schema.GroupVersionResource{Group: "alerting.dynatrace.kubeform.com", Version: "v1alpha1", Resource: "profiles"}

var profilesKind = schema.GroupVersionKind{Group: "alerting.dynatrace.kubeform.com", Version: "v1alpha1", Kind: "Profile"}
