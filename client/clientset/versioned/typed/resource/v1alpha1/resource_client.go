...
// ResourceV1alpha1Client is used to interact with features provided by the resource.dynatrace.kubeform.com group.
type ResourceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ResourceV1alpha1Client) Attributeses(namespace string) AttributesInterface {
	return newAttributeses(c, namespace)
}
