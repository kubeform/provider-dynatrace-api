...
import (
	v1alpha1 "kubeform.dev/provider-dynatrace-api/apis/mobile/v1alpha1"
...
// MobileV1alpha1Client is used to interact with features provided by the mobile.dynatrace.kubeform.com group.
type MobileV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MobileV1alpha1Client) Applications(namespace string) ApplicationInterface {
