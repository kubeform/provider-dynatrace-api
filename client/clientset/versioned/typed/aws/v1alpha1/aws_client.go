...
// AwsV1alpha1Client is used to interact with features provided by the aws.dynatrace.kubeform.com group.
type AwsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AwsV1alpha1Client) Credentialses(namespace string) CredentialsInterface {
