...
type FakeNotifications struct {
	Fake *FakeNotificationV1alpha1
	ns   string
}

var notificationsResource = schema.GroupVersionResource{Group: "notification.dynatrace.kubeform.com", Version: "v1alpha1", Resource: "notifications"}

var notificationsKind = schema.GroupVersionKind{Group: "notification.dynatrace.kubeform.com", Version: "v1alpha1", Kind: "Notification"}
