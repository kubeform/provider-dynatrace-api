...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/environment/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnvironmentV1alpha1().Environments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnvironmentV1alpha1().Environments(namespace).Watch(context.TODO(), options)
			},
		},
		&environmentv1alpha1.Environment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *environmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&environmentv1alpha1.Environment{}, f.defaultInformer)
}
