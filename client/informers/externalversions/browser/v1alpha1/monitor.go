...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/browser/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BrowserV1alpha1().Monitors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrowserV1alpha1().Monitors(namespace).Watch(context.TODO(), options)
			},
		},
		&browserv1alpha1.Monitor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *monitorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&browserv1alpha1.Monitor{}, f.defaultInformer)
}
