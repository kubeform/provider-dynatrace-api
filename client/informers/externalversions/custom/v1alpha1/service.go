	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Services(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Services(namespace).Watch(context.TODO(), options)
			},
		},
		&customv1alpha1.Service{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customv1alpha1.Service{}, f.defaultInformer)
}
