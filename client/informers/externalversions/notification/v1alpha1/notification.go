...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/notification/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NotificationV1alpha1().Notifications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NotificationV1alpha1().Notifications(namespace).Watch(context.TODO(), options)
			},
		},
		&notificationv1alpha1.Notification{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *notificationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&notificationv1alpha1.Notification{}, f.defaultInformer)
}
