...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/alerting/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlertingV1alpha1().Profiles(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlertingV1alpha1().Profiles(namespace).Watch(context.TODO(), options)
			},
		},
		&alertingv1alpha1.Profile{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *profileInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alertingv1alpha1.Profile{}, f.defaultInformer)
}
