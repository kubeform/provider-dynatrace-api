...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/user/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UserV1alpha1().Groups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UserV1alpha1().Groups(namespace).Watch(context.TODO(), options)
			},
		},
		&userv1alpha1.Group{},
		resyncPeriod,
...
func (f *groupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&userv1alpha1.Group{}, f.defaultInformer)
}
