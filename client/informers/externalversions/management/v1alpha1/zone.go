...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/management/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ManagementV1alpha1().Zones(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ManagementV1alpha1().Zones(namespace).Watch(context.TODO(), options)
			},
		},
		&managementv1alpha1.Zone{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *zoneInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&managementv1alpha1.Zone{}, f.defaultInformer)
}
