	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HostV1alpha1().Namings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HostV1alpha1().Namings(namespace).Watch(context.TODO(), options)
			},
		},
		&hostv1alpha1.Naming{},
		resyncPeriod,
...
func (f *namingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hostv1alpha1.Naming{}, f.defaultInformer)
}
