...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/aws/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().Credentialses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().Credentialses(namespace).Watch(context.TODO(), options)
			},
		},
		&awsv1alpha1.Credentials{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *credentialsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.Credentials{}, f.defaultInformer)
}
