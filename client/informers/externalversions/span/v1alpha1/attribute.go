	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpanV1alpha1().Attributes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpanV1alpha1().Attributes(namespace).Watch(context.TODO(), options)
			},
		},
		&spanv1alpha1.Attribute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *attributeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spanv1alpha1.Attribute{}, f.defaultInformer)
}
