...
type AttributeInformer interface {
	...
	Lister() v1alpha1.AttributeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RequestV1alpha1().Attributes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RequestV1alpha1().Attributes(namespace).Watch(context.TODO(), options)
			},
		},
		&requestv1alpha1.Attribute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *attributeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&requestv1alpha1.Attribute{}, f.defaultInformer)
}

func (f *attributeInformer) Lister() v1alpha1.AttributeLister {
	return v1alpha1.NewAttributeLister(f.Informer().GetIndexer())
}
