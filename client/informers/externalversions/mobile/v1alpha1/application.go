...
import (
	...
	v1alpha1 "kubeform.dev/provider-dynatrace-api/client/listers/mobile/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MobileV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MobileV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
		&mobilev1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mobilev1alpha1.Application{}, f.defaultInformer)
}
